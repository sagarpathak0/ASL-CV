...
def main():
    ...
    parser.add_argument("--roi-size", type=int, default=300, 
                        help="Size of ROI square (default: 300)")
    ...
    try:
        ...
        print("Show ASL signs in the blue rectangle area")
        ...
        while True:
            ...
            if key == ord('q'):
                break
            elif key == ord('s') and predicted_class != "Unclear" and predicted_class != "Error":
